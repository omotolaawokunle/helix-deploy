    ...
    */
    ...
    'connections' => [
        ...
        'reverb' => [
            ...
            'options' => [
                // Server-side publishing from API/workers: use internal Reverb in Docker (reverb:8080).
                // REVERB_HOST/PORT/SCHEME remain the public client-facing values for browsers.
