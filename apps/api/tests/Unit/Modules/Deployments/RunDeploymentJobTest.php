...
function stubDeploymentSsh(string $domain, string $deploymentId): FakeSSHConnection
{
    ...
    $responses = [
        ...
        'sudo mkdir -p *' => array_fill(0, 8, $success()),
        'sudo chown -R *' => array_fill(0, 8, $success()),
        'git clone *' => $success(),
