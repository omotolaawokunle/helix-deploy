...
use App\Modules\Provisioning\Controllers\ProvisioningVersionController;
...
use App\Modules\Servers\Controllers\ServerDatabaseController;
use App\Modules\Servers\Controllers\ServerServiceCredentialController;
...
Route::middleware(['web', 'auth:sanctum', 'verified', 'api.token.abilities'])->prefix('v1')->group(function (): void {
    ...
    Route::get('/provisioning/service-versions', [ProvisioningVersionController::class, 'index']);
    ...
    Route::get('/sites/{site}/database/tables', [SiteDatabaseController::class, 'tables']);
    Route::get('/sites/{site}/database/tables/{table}/rows', [SiteDatabaseController::class, 'rows']);
    ...
    Route::get('/servers/{server}/logs', [ServerLogController::class, 'show']);
    ...
    Route::get('/servers/{server}/service-credentials', [ServerServiceCredentialController::class, 'index']);
    Route::post('/servers/{server}/service-credentials/{credential}/reveal', [ServerServiceCredentialController::class, 'reveal']);
    Route::get('/servers/{server}/databases', [ServerDatabaseController::class, 'databases']);
    Route::get('/servers/{server}/databases/{database}/tables', [ServerDatabaseController::class, 'tables']);
    Route::get('/servers/{server}/databases/{database}/tables/{table}/rows', [ServerDatabaseController::class, 'rows']);
